---
id: ""                               # e.g. INCOMPLETE-COM-PLP-CAROUSEL-001
object_type: IncompleteWork
title: ""
status: ""                           # Open | Deferred | Abandoned | Resolved
...
**Schema version:** 2.0
**Use this when:** Creating or documenting a new Incomplete Work object.
**Do not use this when:** When another more specific object type better describes what you are documenting.
**Source-of-truth folder:** `product/objects/incomplete-works/`
