...
|---|---|---|---|---|
| REQ | Feature / change / bug requests | 0009 | 0010 | All incoming requests |
...
| US | User stories | 0035 | 0036 | Multiple per PRD |
| DEVPLAN | Development plans | 0008 | 0009 | One per PRD or story set |
...
| SCR-ADM | Admin screen registry | 0013 | 0014 | Admin panel screens — 0001 to 0011 assigned in Phase 2; 0012 (Admin Coupon List), 0013 (Admin Coupon Form) assigned for PRD-COM-CART-COUPON-V1 |
